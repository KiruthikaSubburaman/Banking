			...
			<form:form action="addcustomer" method="post"
                ...
                <td>
					<form:input path="customerName"
					 pattern="^[A-Za-z]\\w{2,20}$" title="Name must be in letters" required="true"/>
                </td>
				</tr>
				...
				<tr>
					...
					<td>
					<form:input path="fatherName" pattern="^[A-Za-z]\\w{2,20}$" title="Name must be in letters" required="true" />
				    </td>
				...
				<tr>
					...
					<td>
					<form:input path="mobileNumber" pattern="^\\d{10}$" title="Mobile number must be number" maxlength="10" required="true" />
				</td>
