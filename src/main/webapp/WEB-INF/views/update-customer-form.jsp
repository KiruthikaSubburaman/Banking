	...
	<form:form action="updatecustomer" method="post"
                ...
                <td>
					<form:input path="customerName"
					 pattern="^[A-Za-z]\\w{3,20}$" title="Name must be in letters" required="true"/>
                </td>
				</tr>
				...
				<tr>
					...
					<td>
					<form:input path="fatherName" pattern="^[A-Za-z]\\w{3,20}$" title="Name must be in letters" required="true" />
				    </td>
				...
				<tr>
					...
					<td>
					<form:input path="address" pattern="^[A-Za-z]\\w{3,20}$" title="Enter valid address" required="true "/>
				</td>
				...
				<tr>
					...
					<td>
					<form:input path="pinCode" title= "pincode must be in number,Mention correct pincode" maxlength="6" required="true" />
				</td>
				...
				<tr>
					...
					<td>
					<form:input path="mobileNumber" pattern="^\\d{10}$" title="enter your 10 digit mobile number " maxlength="10" required="true" />
				</td>
				<form:errors path="mobileNumber" cssClass="text-danger" />
				<tr>
					<td><label for="email">Email</label></td>
					<td>
					<form:input path="email" pattern= "[a-z0-9._%+-]+@[a-z0-9.-]+\\.[a-z]{2,3}" title="enter valid email" required="true" />
				</tr>
